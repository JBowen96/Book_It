...
const SearchBooks = () => {
  ...
  // Initialize the SAVE_BOOK mutation, allowing a book to be saved to the user's profile; 'saveBook' triggers the mutation, and 'error' catches any errors that occur while attempting to execute the mutation.
